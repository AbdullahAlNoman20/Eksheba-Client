      ...
      <section className="">
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            ...
            <a className="text-3xl font-extrabold"><i className=" text-orange-600 fas fa-dice-one    "></i> EkSheba</a>
          </div>
              ...
              <div className="flex items-center">
                ...
                <div className="avatar online w-12 mr-3">
                  <div className="w-24 rounded-full">
                    <img src={user.photo || "https://i.ibb.co.com/YTpV1SW/photo-2024-10-19-00-57-15.jpg"} />
                  </div>
                </div>
                <NavLink to="/Login">
                  <button
